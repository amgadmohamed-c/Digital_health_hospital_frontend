...
export default function NurseNavBar() {
  ...
  const navLinks = [
    ...
    { name: "Surgeries",   path: "/nurse/surgeries" },
    { name: "Emergency",   path: "/nurse/emergency" },
    { name: "Profile",     path: "/nurse/profile" },
  ];

  return (
    <div className="min-h-screen bg-slate-100 p-4">
      <nav className="sticky top-4 z-50 mb-6">
        <div className="backdrop-blur-xl bg-gradient-to-r from-slate-900/95 via-emerald-950/95 to-slate-900/95 border border-white/10 shadow-2xl rounded-3xl px-6 py-4">
